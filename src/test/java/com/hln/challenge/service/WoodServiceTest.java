...
public class WoodServiceTest {
    ...
    void testGetBundles() {
        ...
        // Setup mock behavior for both wood types
        when(woodRepository.findByWoodType_Type("OAK")).thenReturn(Collections.singletonList(oakWood));
        when(woodRepository.findByWoodType_Type("PINE")).thenReturn(Collections.singletonList(pineWood));
