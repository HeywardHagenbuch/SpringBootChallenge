...
public class WoodApplicationIntegrationTest {
    ...
    @BeforeEach
    void setUp() {
        mockMvc = MockMvcBuilders.standaloneSetup(woodController).build();
        insertTestData();
    }
    ...
    void testInvalidFileUpload() {
        ...
        assertThrows(ServletException.class, () -> mockMvc.perform(multipart("/api/upload/OAK").file(invalidFile)));
    }
